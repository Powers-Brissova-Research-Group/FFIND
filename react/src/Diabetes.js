      ...
      <div className="diabetes">
        ...
        <Container className='v-padded'>
          <Row>
            ...
            <Col md="6">
              <iframe title='Diabetes Video' width="560" height="315" src="https://www.youtube-nocookie.com/embed/wmOW091P2ew?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
