        ...
        <footer className='footer footer-lower'>
          <Container fluid>
            <Container>
              <Row className='v-padded'>
                <Col md='8'>
                  <p>Developed and managed by Jimmy Messmer (<a href='https://www.powersbrissovaresearch.org'>Powers Laboratory</a>) and JP Cartailler (<a href='https://cds.vanderbilt.edu'>Creative Data Solutions</a>)</p>
