          ...
          <CardBody className='d-flex flex-column'>
            ...
            <div className='marker-list'>
              {Object.keys(this.state.markers).slice(0, Object.keys(this.state.markers).length - 1).map(marker => (
                <MarkerTag filterActive={this.props.filterActive} key={`${marker.replace(' ', '_').replace(/[^0-9a-zA-Z\-_]/gi, '')}`} filterCallback={this.props.filterCallback} marker={marker} iid={this.props.iid} color={this.state.markerColors[marker]} />
              ...
              {(Object.keys(this.state.markers).length > 0 && Object.keys(this.state.markers)[0] !== 'DEFAULT VAL') ? (
                <MarkerTag filterActive={this.props.filterActive} key={`${this.state.markers[lastMarker].replace(' ', '_').replace(/[^0-9a-zA-Z\-_]/gi, '')}`} filterCallback={this.props.filterCallback} marker={lastMarker} iid={this.props.iid} color={this.state.markerColors[lastMarker]} />
              ) : null}
