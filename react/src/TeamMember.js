    ...
    return (
      <Card className='h-100'>
        ...
        <CardFooter className='d-flex justify-content-around'>
          <a href={this.props.site}><FontAwesomeIcon size='1x' icon='link' /></a>
          <a href={this.props.email}><FontAwesomeIcon size='1x' icon='envelope' /></a>
          <a href={this.props.phone}><FontAwesomeIcon size='1x' icon='phone' /></a>
        </CardFooter>
      </Card>
    )
  }
