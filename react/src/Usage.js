    ...
    return (
      <div className='usage'>
        <MetaTags>
          ...
          <meta name='description' content='Pancreatlas data usage and citation policies' />
        </MetaTags>
        {/* <Header heading="About" /> */}
        <PageBanner image bgImg={require('./assets/pancreatlas/headers/data-usage-header.png')}>
          <h1>Data Usage and Citation Policies</h1>
          <p className='text-larger'>In order to ensure the fair usage of the data presented on Pancreatlas, we have created these usage and citation guidelines.</p>
        </PageBanner>
          ...
          <Row className='mb-4'>
            <Col md='12'>
              <div>
                ...
                <ul>
                  <li>Your use must be for research or other noncommercial purposesand must be in compliance with all applicable federal, state and local laws and regulations</li>
          ...
          <Container>
            <Row>
              <Col md='12' className='my-4'>
                ...
                <p><em>* Because images in Pancreatlas originate from a variety of sources, please be aware that citation requirements for images or Collections may vary. Information for currently published Collections (v1.1) are provided for convenience below</em></p>
                <p>
                  <div><strong>Cystic Fibrosis-Related Diabetes (CFRD)</strong></div>
                  <div>Hart NJ et al., 2018. Cystic fibrosis-related diabetes is caused by islet loss and inflammation. JCI Insight. PubMed:29669939 DOI:10.1172/jci.insight.98240</div>
                </p>
                <p>
